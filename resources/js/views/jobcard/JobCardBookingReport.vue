<template>
  <div class="container-fluid">
    <breadcrumb :options="['Job Card Booking Report']">
                ...
                <form @submit.prevent="handleSubmit(filterAllReport)" @keydown.enter="$event.preventDefault()">
                  <div class="row">
                    <div class="col-md-2">
                      ...
                      <div class="col-md-2">
                          <ValidationProvider name="Customer" mode="eager" v-slot="{ errors }"   rules="required">
                          <div class="form-group">
...
export default {
  ...
  methods: {
    filterAllReport(){
      this.loaderTag = true
      this.form.post(baseurl + "api/jobCard/job-card-booking-report", this.config()).then(response => {
      ...
      this.form.post(baseurl + "api/jobCard/job-card-booking-report", this.config()).then(response => {
        ...
        if (dataSets.length > 0) {
          ...
          columns = columns.map((item) => {
            ...
            this.generateExport(dataSets, columns, 'Job Card Booking Report')
