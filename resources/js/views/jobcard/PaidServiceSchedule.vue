<template>
  <div class="container-fluid">
    <breadcrumb :options="['Paid Service Schedule List']">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="datatable" v-if="!isLoading">
            <div class="card-body">
              <ValidationObserver v-slot="{ handleSubmit }">
                <form @submit.prevent="handleSubmit(getAllPaidServiceSchedule)" @keydown.enter="$event.preventDefault()">
                  <div class="row">
                ...
                <div class="row">
                  ...
                  <div class="col-8">
                    <report-pagination
                        ...
                        :offset="5"
                        @paginate="form.Query === '' ? getAllPaidServiceSchedule() : getAllPaidServiceSchedule()"
                    ></report-pagination>
                  </div>
                </div>
              </div>
          ...
          <add-edit-paid-service-schedule  @changeStatus="changeStatus" v-if="loading"/>
          <div v-else>
...
export default {
  name: "Paid Service Schedule List",
  mixins: [Common],
  ...
  mounted() {
    document.title = 'Paid Service Schedule List | DMS';
    this.getAllPaidServiceSchedule();
  ...
  methods: {
    getAllPaidServiceSchedule(){
      this.isLoading = true
      this.form.Export = '';
      this.form.post(baseurl + "api/jobCard/paid-service-schedule", this.config()).then(response => {
