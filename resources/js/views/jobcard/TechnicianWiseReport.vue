<template>
  <div class="container-fluid">
    <breadcrumb :options="['Technician Wise Report']">
            ...
            <div class="card-body">
                      ...
                      <div class="col-md-2">
                          ...
                          <div class="form-group">
                              ...
                              <select name="jobStatus" class="form-control" v-model="form.CustomerCode" style="margin: 0">
                                  ...
                                  <option :value="singleCustomer.value" v-for="(singleCustomer , index) in customer" :key="index">{{ singleCustomer.text }}</option>
                              </select>
              ...
              <div v-if="contents.length > 0">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped dt-responsive nowrap dataTable no-footer dtr-inline table-sm small">
                    ...
                    <tr v-for="(item, index) in contents" >
                      <td v-for="(item2, index) in headers.slice(1)" v-bind:class="isInt(item[item2]) === true ? 'text-right' : '' ">
                        {{ item[item2] }}
                      </td>
                    </tr>
                    </tbody>
                ...
                <div v-else style="text-align: center">
                    <div class="preloader" v-if="loaderTag" id="preloader">
                    <div class="loader">
                    </div>
                </div>
                    <h4 v-if="loaderTag===false"> No data found.</h4>
...
export default {
  ...
  methods: {
    filterAllReport(){
      this.loaderTag = true
      this.form.post(baseurl + "api/jobCard/technician-report", this.config()).then(response => {
      ...
      this.form.post(baseurl + "api/jobCard/technician-report", this.config()).then(response => {
        ...
        if (dataSets.length > 0) {
          ...
          columns = columns.map((item) => {
            ...
            this.generateExport(dataSets, columns, 'Technician Wise Report')
    ...
    getSupportingData() {
          let instance = this;
          this.axiosGet('jobCard/technician-report-supporting-data', function (response) {
              // instance.customer = response.user
