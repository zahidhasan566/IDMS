              ...
              <div v-if="contents.length > 0">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped dt-responsive nowrap dataTable no-footer dtr-inline table-sm small">
                    ...
                    <tr>
                      <th style="background: #333547" v-for="(item, index) in headers" v-if="index !== 0 && index !== 32">
                    ...
                    <tr v-for="(item, index) in contents" >
                      ...
                      <td>
                        <router-link class="btn btn-primary" style="font-size: 12px;width:65px;padding: 2px 0px" target='_blank' :to="{path: `${baseUrl}`+'job-card-print?action_type=print&jobCardNo='+encodeConvert(item.Job_Card_No)}"><i class="fa fa-print">Print</i></router-link>
                      </td>
                    </tr>
                    </tbody>
                  </table>
