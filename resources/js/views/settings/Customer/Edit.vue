<template>
  <div class="container-fluid">
    <breadcrumb :options="['Customer Edit']">
...
export default {
  ...
  created() {
    axios.get(baseurl + `api/settings/customer-edit/${this.$route.params.CustomerCode}`, this.config()).then((response)=>{
  ...
  mounted() {
    document.title = 'Customer Edit | DMS';
    this.getAllCustomerType();
  },
  methods: {
    onSubmit(){
      this.PreLoader = true;
      this.form.post(baseurl + "api/settings/customer-update", this.config()).then(response => {
