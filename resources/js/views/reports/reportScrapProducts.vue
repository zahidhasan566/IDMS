<template>
  <div class="container-fluid">
    <breadcrumb :options="['Scrap Products Report']">
...
export default {
  ...
  methods: {
    filterAllReport(){
      this.isLoading = true
      this.form.Export = '';
      this.form.post(baseurl + "api/reports/scrap-products", this.config()).then(response => {
    ...
    exportReport(){
      ...
      this.form.post(baseurl + "api/reports/scrap-products", this.config()).then(response => {
          ...
          link.href = url;
          link.setAttribute('download', 'scrap_products_data.csv');
