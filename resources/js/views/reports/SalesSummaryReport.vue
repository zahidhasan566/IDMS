<template>
  <div class="container-fluid">
    <breadcrumb :options="['Sales Summary']">
                ...
                <div class="table-responsive">
                  <table class="table table-bordered table-striped dt-responsive nowrap dataTable no-footer dtr-inline table-sm small">
                    ...
                    <tr v-for="(item, index) in contents" >
                      ...
                      <td :style="item2 === 'LMSD_Sales_Growth'||item2 === 'SPLY_Sales_Growth' && item[item2] >= 0 ? 'background:green; color: white;'
                       : item2 === 'LMSD_Sales_Growth'||item2 === 'SPLY_Sales_Growth' && item[item2] < 0 ? 'background:red; color: white;' : ''"
...
export default {
  ...
  methods: {
    filterAllReport(){
      this.isLoading = true
      this.form.Export = '';
      this.form.post(baseurl + "api/reports/sales-summary", this.config()).then(response => {
    ...
    exportReport(){
      ...
      this.form.post(baseurl + "api/reports/sales-summary", this.config()).then(response => {
        ...
        if (dataSets.length > 0) {
          ...
          bus.$emit('data-table-import', dataSets, columns, 'Sales Summary')     
          this.exportShow = false;     
        }
      }).catch(e => {
        //
