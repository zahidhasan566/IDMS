                ...
                <div class="d-flex">
                  <div class="flex-grow-1">
                    <ValidationObserver v-slot="{ handleSubmit }">
                      <form @submit.prevent="handleSubmit(getAllWarrantyClaimReport)" @keydown.enter="$event.preventDefault()">
                        <div class="row">
    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          <div class="datatable" v-if="!isLoading">
            <div class="card-body">
              <div class="d-flex" v-if="contents.length > 0">
                <div class="flex-grow-1">
                ...
                <div class="row">
                  ...
                  <div class="col-8">
                    <report-pagination
                        ...
                        :offset="5"
                        @paginate="form.Query === '' ? getAllWarrantyClaimReport() : getAllWarrantyClaimReport()"
                    ></report-pagination>
                  </div>
                </div>
              </div>
...
export default {
  ...
  mounted() {
    ...
    this.getAllWarrantyClaimReport();
    this.getAllCustomerForSDMSWarranty();
  },
  methods: {
    getAllWarrantyClaimReport(){
      this.isLoading = true
      this.form.Export = '';
      this.form.post(baseurl + "api/sdmsreport/warranty-claim-list", this.config()).then(response => {
    ...
    getAllCustomerForSDMSWarranty(){
      axios.get(baseurl + 'api/get-all-customer-for-sdms-wwaranty-claim-report', this.config() ).then((response)=>{
