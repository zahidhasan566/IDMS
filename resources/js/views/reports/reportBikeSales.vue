<template>
  <div class="container-fluid">
    <breadcrumb :options="['Bike Sales Report']">
...
export default {
  ...
  methods: {
    filterAllReport(){
      this.isLoading = true
      this.form.Export = '';
      this.form.post(baseurl + "api/reports/bike-sales", this.config()).then(response => {
    ...
    exportReport(){
      ...
      exportReportCSV(){
          ...
          this.form.post(baseurl + "api/reports/bike-sales", this.config()).then(response => {
              ...
              link.href = url;
              link.setAttribute('download', 'bike_sales_data.csv');
