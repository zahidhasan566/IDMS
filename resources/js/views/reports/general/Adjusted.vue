<template>
  <div class="container-fluid">
    <breadcrumb :options="['Report of Adjusted Advances']"></breadcrumb>
    <!--STEP 1-->
    <div class="card">
      <div class="row">
        <div class="col-md-4">
...
export default {
  ...
  data() {
    return {
      ...
      department: [],
      tableOptions: {
        source: 'adjustments/report/adjusted',
        search: false,
        filterPayment: true,
        ...
        slotsName: ['advance','expense','adjustment','refund','outstanding','payment'],
        pages: [40, 100],
        addHeader: [],
      },
    }
  ...
  methods: {
    ...
    exportData() {
      bus.$emit('export-data','Adjusted-Advance-Report-'+moment().format('YYYY-MM-DD'))
    }
  }
}
</script>
