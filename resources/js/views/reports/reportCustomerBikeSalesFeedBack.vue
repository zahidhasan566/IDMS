<template>
    <div class="container-fluid">
      <breadcrumb :options="['Bike Sales Customer Feedback']">
  ...
  export default {
    ...
    methods: {
      filterAllReport(){
        this.isLoading = true
        this.form.Export = '';
        this.form.post(baseurl + "api/reports/customer-bike-sales-feedBack", this.config()).then(response => {
      ...
      exportReport(){
        ...
        this.form.post(baseurl + "api/reports/customer-bike-sales-feedBack", this.config()).then(response => {
          ...
          if (dataSets.length > 0) {
            ...
            bus.$emit('data-table-import', dataSets, columns, 'Bike Sales Customer Feedback')
            this.exportShow = false;
          }
        }).catch(e => {
          //
