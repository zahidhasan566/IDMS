<template>
    <div class="container-fluid">
      <breadcrumb :options="['Estimated Free Service Report']">
  ...
  export default {
    ...
    methods: {
      filterAllReport(){
        this.isLoading = true
        this.form.Export = '';
        this.form.post(baseurl + "api/reports/estimated-free-service", this.config()).then(response => {
      ...
      exportReport(){
        ...
        this.form.post(baseurl + "api/reports/estimated-free-service", this.config()).then(response => {
          ...
          if (dataSets.length > 0) {
            ...
            bus.$emit('data-table-import', dataSets, columns, 'Estimated Free Service Report')
            this.exportShow = false;
          }
        }).catch(e => {
          //
