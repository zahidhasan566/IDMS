              ...
              <div class="d-flex">
                <div class="flex-grow-1">
                  <ValidationObserver v-slot="{ handleSubmit }">
                    <form @submit.prevent="handleSubmit(getAllCancelWarranty)" @keydown.enter="$event.preventDefault()">
                      <div class="row">
                        <div class="col-md-2">
                ...
                <div class="row">
                  ...
                  <div class="col-8">
                    <report-pagination
                        ...
                        :offset="5"
                        @paginate="form.Query === '' ? getAllCancelWarranty() : getAllCancelWarranty()"
                    ></report-pagination>
                  </div>
                </div>
              </div>
...
export default {
  ...
  mounted() {
    document.title = 'Cancel Warranty List | DMS';
    this.getAllCancelWarranty();
  },
  methods: {
    getAllCancelWarranty(){
      this.isLoading = true
      this.form.Export = '';
      this.form.post(baseurl + "api/get-all-cancel-warranty", this.config()).then(response => {
