<template>
  <div class="container-fluid">
    <breadcrumb :options="['Approved Warranty List']">
              ...
              <div class="d-flex">
                <div class="flex-grow-1">
                  <ValidationObserver v-slot="{ handleSubmit }">
                    <form @submit.prevent="handleSubmit(getAllApprovedWarranty)" @keydown.enter="$event.preventDefault()">
                      <div class="row">
                        <div class="col-md-2">
...
<!--                        </div>-->
              ...
              <div v-if="contents.length > 0">
                <div class="table-responsive">
                  <table class="table table-bordered table-striped dt-responsive nowrap dataTable no-footer dtr-inline table-sm small thead-dark">
                    ...
                    <tr v-for="(item, index) in contents" >
                      ...
                      <td>
                        <router-link :to="`warranty-print/${item.Warranty_Id}`" style="height: 18px;padding: 0px 3px 18px 3px;" class="btn btn-info btn-sm">
                ...
                <div class="row">
                  ...
                  <div class="col-8">
                    <report-pagination
                        ...
                        :offset="5"
                        @paginate="form.Query === '' ? getAllApprovedWarranty() : getAllApprovedWarranty()"
                    ></report-pagination>
                  </div>
                </div>
              </div>
...
export default {
  ...
  mounted() {
    document.title = 'Approved Warranty List | DMS';
    this.getAllApprovedWarranty();
  },
  methods: {
    getAllApprovedWarranty(){
      this.isLoading = true
      this.form.Export = '';
      this.form.post(baseurl + "api/get-all-approved-warranty", this.config()).then(response => {
