            ...
            <div class="page-title-box">
                <div class="row align-items-center">
                    <div class="col-sm-6">
                        ...
                        <ol class="breadcrumb">
                            <li class="breadcrumb-item active">Send Agrimotors Call</li>
                        </ol>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-2">
                                            <ValidationProvider name="Customer" mode="eager" v-slot="{ errors }"  
                                                >
                                            <div class="form-group">
                                                <label>Request For <span class="error">*</span></label>
                                                <select name="requestType" class="form-control" v-model="form.requestType" style="margin: 0">
                                                    <option value="Tractor">Tractor</option>
                                                    <option value="Harvester">Harvester</option> 
                                                </select>
                                                <div class="error" v-if="form.errors.has('requestType')" v-html="form.errors.get('requestType')" />
                                                <span class="error-message"> {{ errors[0] }}</span>
                                            </div>
                                            </ValidationProvider>
                                        </div>  
...
export default {
    ...
    methods: {
        onSubmit(){
            this.isLoading = true
            this.form.post(baseurl + "api/iHelpBD/send-agrimotors-call", this.config()).then(response => {
