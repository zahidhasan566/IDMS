<template>
  <div class="container-fluid">
    <breadcrumb :options="['Invoice List']">
      <router-link :to="{name: 'InvoiceCreate'}" class="btn btn-primary btn-sm">Add Invoice</router-link>
              ...
              <div class="d-flex">
                <div class="flex-grow-1">
                  <ValidationObserver v-slot="{ handleSubmit }">
                    <form @submit.prevent="handleSubmit(getAllInvoice)" @keydown.enter="$event.preventDefault()">
                      <div class="row">
                        <div class="col-md-2">
...
export default {
  ...
  mounted() {
    document.title = 'Invoice List | DMS';
    this.getAllInvoice();
  },
  methods: {
    getAllInvoice(){
      this.isLoading = true
      this.form.Export = '';
      this.form.post(baseurl + "api/get-all-invoice", this.config()).then(response => {
