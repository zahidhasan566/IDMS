...
<!--                              <div class="error" v-if="form.errors.has('ChassisNo')" v-html="form.errors.get('ChassisNo')" />-->
                        ...
                        <div class="col-12 col-md-2">
                          <ValidationProvider name="Discount" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Discount</label>
                              <input type="number" class="form-control" name="Discount" v-model="form.Discount" @change="setDiscount">
                      ...
                      <div class="form-divider m-b-15">
                        ...
                        <div class="row">
                          <div class="col-md-5">
                            ...
                            <ValidationProvider name="Address" mode="eager" rules="required" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-4 col-form-label text-right">Address<span style="color: red">*</span></label>
                                <div class="col-lg-8">
                                  <input name="Address" type="text" class="form-control" v-model="form.Address" />
                            ...
                            <ValidationProvider name="InquirySale" mode="eager" rules="required" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-4 col-form-label text-right">Inquiry Sale?<span style="color: red">*</span></label>
                                <div class="col-lg-8">
                                  <select name="InquirySale" class="form-control" v-model="form.InquirySale" style="margin: 0">
                                    <option value="1">Yes</option>
                                    <option value="0">No</option>
                                  </select>
                                  <div class="error" v-if="form.errors.has('InquirySale')" v-html="form.errors.get('InquirySale')" />
                                  <span class="error-message"> {{ errors[0] }}</span>
                                </div>
                              </div>
                            </ValidationProvider>
                          ...
                          <div class="col-md-7">
                            <ValidationProvider name="CustomerOccupation" mode="eager" rules="required" v-slot="{ errors }">
                            <div class="form-group row" style="padding-bottom: 10px">
                              <label class="col-lg-7 col-form-label text-right">Customer Occupation<span style="color: red">*</span></label>
                              <div class="col-lg-5 text-left">
                                <select name="CustomerOccupation" class="form-control" v-model="form.CustomerOccupation" style="margin: 0">
                                  <option :value="occupation.OccupationId" v-for="(occupation , index) in occupations" :key="index">{{ occupation.OccupationName }}</option>
                                </select>
                                <div class="error" v-if="form.errors.has('CustomerOccupation')" v-html="form.errors.get('CustomerOccupation')" />
                                <span class="error-message"> {{ errors[0] }}</span>
                              </div>
                            </div>
                            </ValidationProvider>
                            <ValidationProvider name="OwnerTyp" mode="eager" rules="required" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-7 col-form-label text-right">Owner Typ<span style="color: red">*</span></label>
                                <div class="col-lg-5 text-left">
                                  <select name="OwnerTyp" class="form-control" v-model="form.OwnerTyp" style="margin: 0">
                                  ...
                                  <div class="error" v-if="form.errors.has('OwnerTyp')" v-html="form.errors.get('OwnerTyp')" />
                                  <span class="error-message"> {{ errors[0] }}</span>
                                </div>
                              </div>
                            </ValidationProvider>
                            ...
                            <ValidationProvider name="Mobile" mode="eager" rules="required" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-7 col-form-label text-right">Mobile<span style="color: red">*</span></label>
                                <div class="col-lg-5 text-left">
                            ...
                            <ValidationProvider name="ThanaCode" mode="eager" rules="required" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-7 col-form-label text-right">Thana<span style="color: red">*</span></label>
                                <div class="col-lg-5 text-left">
                            ...
                            <div class="form-group row" style="padding-bottom: 10px">
                              ...
                              <div class="col-lg-5 text-left">
                                <input @change="changeImage($event)" type="file" name="Photo" class="form-control" :class="{ 'is-invalid': form.errors.has('Photo') }">
                                <img v-if="form.Photo" :src="showImage(form.Photo)" alt="" height="40px" width="40px">
                                <div class="error" v-if="form.errors.has('Photo')" v-html="form.errors.get('Photo')" />
                              </div>
                            </div>
                            <ValidationProvider name="MonthlyIncome" mode="eager" rules="required" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-7 col-form-label text-right">Monthly Income<span style="color: red">*</span></label>
                                <div class="col-lg-5 text-left">
                                  <select name="MonthlyIncome" class="form-control" v-model="form.MonthlyIncome" style="margin: 0">
                                    <option :value="income.IncomeId" v-for="(income , index) in monthly_income" :key="index">{{ income.Income }}</option>
                                  </select>
                                  <div class="error" v-if="form.errors.has('OwnerTyp')" v-html="form.errors.get('OwnerTyp')" />
                                  <span class="error-message"> {{ errors[0] }}</span>
                                </div>
                            ...
                            <ValidationProvider name="ProductIntroducingMedia" mode="eager" rules="required" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                ...
                                <div class="col-lg-5 text-left">
                                  ...
                                  <div class="error" v-if="form.errors.has('ProductIntroducingMedia')" v-html="form.errors.get('ProductIntroducingMedia')" />
                                  <span class="error-message"> {{ errors[0] }}</span>
                                </div>
                              </div>
                            </ValidationProvider>
                              ...
                              <div class="form-group row" style="padding-bottom: 10px">
                                ...
                                <div class="col-lg-5 text-left">
                                  <multiselect
                                      ...
                                      placeholder="Pick a value"></multiselect>
                                  <div class="error" v-if="form.errors.has('interestInProduct')" v-html="form.errors.get('interestInProduct')" />
                                  <span class="error-message"> {{ errors[0] }}</span>
                                </div>
                              </div>
                            </ValidationProvider>
                            <ValidationProvider name="previouslyUsedBike" mode="eager" rules="required" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-7 col-form-label text-right">If you did own any two wheelers previously or do now, what is the brand of the bike?<span style="color: red">*</span></label>
                                <div class="col-lg-5 text-left">
                                  <multiselect
                                      ...
                                      track-by="BikeName"
                                      placeholder="Pick a value"></multiselect>
                                  <div class="error" v-if="form.errors.has('previouslyUsedBike')" v-html="form.errors.get('previouslyUsedBike')" />
                                  <span class="error-message"> {{ errors[0] }}</span>
                                </div>
                              </div>
                            </ValidationProvider>
                            ...
                            <ValidationProvider name="previousBikeUsage" mode="eager" rules="" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-7 col-form-label text-right">What did you do with the previous bike?</label>
                                <div class="col-lg-5 text-left">
                                  <select name="previousBikeUsage" class="form-control" v-model="form.previousBikeUsage" style="margin: 0">
                                    <option :value="use.BikeUsage" v-for="(use , index) in previousBikeUsage" :key="index">{{ use.BikeUsageDetails }}</option>
                                  </select>
                                  <div class="error" v-if="form.errors.has('previousBikeUsage')" v-html="form.errors.get('previousBikeUsage')" />
                                  <span class="error-message"> {{ errors[0] }}</span>
                                </div>
                              </div>
                            </ValidationProvider>
                            <ValidationProvider name="causeForBuyingNewBike" mode="eager" rules="" v-slot="{ errors }">
                              <div class="form-group row" style="padding-bottom: 10px">
                                <label class="col-lg-7 col-form-label text-right">Why are you buying the new bike?</label>
                                <div class="col-lg-5 text-left">
                                  <multiselect
                                      ...
                                      track-by="Cause"
                                      placeholder="Pick a value"></multiselect>
                                  <div class="error" v-if="form.errors.has('causeForBuyingNewBike')" v-html="form.errors.get('causeForBuyingNewBike')" />
                                  <span class="error-message"> {{ errors[0] }}</span>
                                </div>
                              </div>
                            </ValidationProvider>
                            ...
                            <div class="form-group row" style="padding-bottom: 10px">
                              <label class="col-lg-7 col-form-label text-right">Marriage Day (yyyy-mm-dd)</label>
                              <div class="col-lg-5 text-left">
                                <date-picker v-model="form.MarriageDay" valueType="format"></date-picker>
                              </div>
                            </div>
                          </div>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-6">
                      <div class="row form-divider m-b-15">
                        ...
                        <div class="col-6 col-md-4">
                          <ValidationProvider name="IsEmi" mode="eager" rules="required" v-slot="{ errors }">
                            <div class="form-group">
                              <label>EMI?</label>
                              <select name="IsEmi" class="form-control" v-model="form.IsEmi" @change="changeIsEmi">
                                <option value="0">No</option>
                                <option value="1">Yes</option>
                              </select>
                              <div class="error" v-if="form.errors.has('IsEmi')" v-html="form.errors.get('IsEmi')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-4" v-if="IsEmiEnable">
                          <ValidationProvider name="InstallmentSize" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Installment Size (If Yes)</label>
                              <select name="InstallmentSize" class="form-control" v-model="form.InstallmentSize " style="margin: 0" @change="calculatePayableInterest">
                                <option :value="emi.installmentsize" v-for="(emi , index) in emi_installment" :key="index">{{ emi.installmentsize }}</option>
                              </select>
                              <div class="error" v-if="form.errors.has('InstallmentSize')" v-html="form.errors.get('InstallmentSize')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-4" v-if="IsEmiEnable">
                          <ValidationProvider name="EmiBank" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>EMI Bank*</label>
                              <select name="EmiBank" class="form-control" v-model="form.EmiBank " style="margin: 0" @change="calculatePayableInterest">
                                <option :value="bank.emibankid" v-for="(bank , index) in emi_bank" :key="index">{{ bank.emibankname }}</option>
                              </select>
                              <div class="error" v-if="form.errors.has('EmiBank')" v-html="form.errors.get('EmiBank')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-4" v-if="IsEmiEnable">
                          <ValidationProvider name="EmiAmount" mode="eager" rules="required" v-slot="{ errors }">
                            <div class="form-group">
                              <label>EMI Amount*</label>
                              <input type="number" class="form-control" name="EmiAmount" v-model="form.EmiAmount" @keyup="calculatePayableInterest">
                              <div class="error" v-if="form.errors.has('EmiAmount')" v-html="form.errors.get('EmiAmount')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-4" v-if="IsEmiEnable">
                          <ValidationProvider name="InterestRate" mode="eager" rules="required" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Interest Rate</label>
                              <input type="number" class="form-control" name="InterestRate" readonly v-model="form.InterestRate">
                              <div class="error" v-if="form.errors.has('InterestRate')" v-html="form.errors.get('InterestRate')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-4" v-if="IsEmiEnable">
                          <ValidationProvider name="InterestPayable" mode="eager" rules="required" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Interest Payable</label>
                              <input type="number" class="form-control" name="InterestPayable" readonly v-model="form.InterestPayable">
                              <div class="error" v-if="form.errors.has('InterestPayable')" v-html="form.errors.get('InterestPayable')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                    ...
                    <div class="col-md-6">
                      <div class="row form-divider m-b-15">
                        ...
                        <div class="col-6 col-md-4">
                          <ValidationProvider name="SalesStaffName" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Sales Staff Name</label>
                              <input type="text" class="form-control" name="SalesStaffName" v-model="form.SalesStaffName">
                              <div class="error" v-if="form.errors.has('SalesStaffName')" v-html="form.errors.get('SalesStaffName')" />
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-4">
                          <ValidationProvider name="SalesStaffDesignation" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Sales Staff Designation</label>
                              <input type="text" class="form-control" name="SalesStaffDesignation" v-model="form.SalesStaffDesignation">
                              <div class="error" v-if="form.errors.has('SalesStaffDesignation')" v-html="form.errors.get('SalesStaffDesignation')" />
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-4">
                          <ValidationProvider name="MechanicsCode" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Local Mechanics</label>
                              <select name="MechanicsCode" class="form-control" v-model="form.MechanicsCode">
                                <option :value="mechanic.MechanicsCode" v-for="(mechanic , index) in mechanics" :key="index">{{ mechanic.UpazillaName }} - {{ mechanic.MechanicsName }}</option>
                              </select>
                              <div class="error" v-if="form.errors.has('MechanicsCode')" v-html="form.errors.get('MechanicsCode')" />
                            </div>
                          </ValidationProvider>
                        </div>
                      </div>
                  ...
                  <div class="row">
                    <div class="col-md-12">
                      <div class="row form-divider m-b-15">
                        ...
                        <div class="col-12 col-md-2">
                          <ValidationProvider name="IsExchange" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Exchange?</label>
                              <select name="IsExchange" class="form-control" v-model="form.IsExchange" @change="changeIsExchange">
                                <option value="0">No</option>
                                <option value="1">Yes</option>
                              </select>
                              <div class="error" v-if="form.errors.has('IsExchange')" v-html="form.errors.get('IsExchange')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-12 col-md-2" v-if="IsExchangeEnable">
                          <ValidationProvider name="ExchangeBrand" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Exchange Brand</label>
                              <select name="ExchangeBrand" class="form-control" v-model="form.ExchangeBrand">
                                <option :value="brand.BrandCode" v-for="(brand , index) in exchange_brand" :key="index">{{ brand.BrandName }}</option>
                              </select>
                              <div class="error" v-if="form.errors.has('ExchangeBrand')" v-html="form.errors.get('ExchangeBrand')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-12 col-md-2" v-if="IsExchangeEnable">
                          <ValidationProvider name="ExchangeEngineNo" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Engine No</label>
                              <input type="text" class="form-control" name="ExchangeEngineNo" v-model="form.ExchangeEngineNo">
                              <div class="error" v-if="form.errors.has('ExchangeEngineNo')" v-html="form.errors.get('ExchangeEngineNo')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-12 col-md-2" v-if="IsExchangeEnable">
                          <ValidationProvider name="ExchangeChassisNo" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Chassis No</label>
                              <input type="text" class="form-control" name="ExchangeChassisNo" v-model="form.ExchangeChassisNo">
                              <div class="error" v-if="form.errors.has('ExchangeChassisNo')" v-html="form.errors.get('ExchangeChassisNo')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-2" v-if="IsExchangeEnable">
                          <ValidationProvider name="BrandName" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Old Bike Brand</label>
                              <select name="BrandName" class="form-control" v-model="form.BrandName" @change="getAllOldBikeModel">
                                <option :value="brand.BrandName" v-for="(brand , index) in OldBikeBrand" :key="index">{{ brand.BrandName }}</option>
                              </select>
                              <div class="error" v-if="form.errors.has('BrandName')" v-html="form.errors.get('BrandName')" />
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-6 col-md-2" v-if="IsExchangeEnable">
                          <ValidationProvider name="ModelName" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Old Bike Model</label>
                              <select name="ModelName" class="form-control" v-model="form.ModelName">
                                <option :value="model.ModelName" v-for="(model , index) in OldBikeModel" :key="index">{{ model.ModelName }}</option>
                              </select>
                              <div class="error" v-if="form.errors.has('ModelName')" v-html="form.errors.get('ModelName')" />
                            </div>
                          </ValidationProvider>
                        </div>
<!--                        <div class="col-12 col-md-2" v-if="IsExchangeEnable">-->
...
<!--                        </div>-->
                        <div class="col-12 col-md-2" v-if="IsExchangeEnable">
                          <ValidationProvider name="OldBikePrice" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Old Bike Price</label>
                              <input type="number" class="form-control" name="OldBikePrice" v-model="form.OldBikePrice">
                              <div class="error" v-if="form.errors.has('OldBikePrice')" v-html="form.errors.get('OldBikePrice')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-12 col-md-2" v-if="IsExchangeEnable">
                          <ValidationProvider name="ExchangeMedium" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Exchange Medium</label>
                              <select name="ExchangeMedium" class="form-control" v-model="form.ExchangeMedium" @change="exchangeMediumEnable">
                                <option value="dealer">Dealer</option>
                                <option value="reseller">Reseller</option>
                              </select>
                              <div class="error" v-if="form.errors.has('ExchangeMedium')" v-html="form.errors.get('ExchangeMedium')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-12 col-md-2" v-if="IsExchangeMediumEnable">
                          <ValidationProvider name="ExchangeCustomerDiscount" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Exchange Customer Discount</label>
                              <input type="number" class="form-control" name="ExchangeCustomerDiscount" v-model="form.ExchangeCustomerDiscount">
                              <div class="error" v-if="form.errors.has('ExchangeCustomerDiscount')" v-html="form.errors.get('ExchangeCustomerDiscount')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-12 col-md-2" v-if="IsExchangeMediumEnable">
                          <ValidationProvider name="ResellerName" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Reseller Name</label>
                              <input type="text" class="form-control" name="ResellerName" v-model="form.ResellerName">
                              <div class="error" v-if="form.errors.has('ResellerName')" v-html="form.errors.get('ResellerName')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-12 col-md-2" v-if="IsExchangeMediumEnable">
                          <ValidationProvider name="ResellerContact" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Reseller Contact</label>
                              <input type="text" class="form-control" name="ResellerContact" v-model="form.ResellerContact">
                              <div class="error" v-if="form.errors.has('ResellerContact')" v-html="form.errors.get('ResellerContact')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                        <div class="col-12 col-md-2" v-if="IsExchangeMediumEnable">
                          <ValidationProvider name="ResellerCommission" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group">
                              <label>Reseller Commission(%)</label>
                              <input type="text" class="form-control" name="ResellerCommission" v-model="form.ResellerCommission">
                              <div class="error" v-if="form.errors.has('ResellerCommission')" v-html="form.errors.get('ResellerCommission')" />
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="row form-divider m-b-15">
                        ...
                        <div class="col-md-12">
                          <ValidationProvider name="TotalPayable" mode="eager" rules="required" v-slot="{ errors }">
                            <div class="form-group row" style="padding-bottom: 10px">
                              <label class="col-lg-4 col-form-label text-center">Total Payable</label>
                              <div class="col-lg-7">
                                <input name="TotalPayable" type="text" class="form-control" readonly v-model="form.TotalPayable" />
                                <div class="error" v-if="form.errors.has('TotalPayable')" v-html="form.errors.get('TotalPayable')" />
                                <span class="error-message"> {{ errors[0] }}</span>
                              </div>
                            </div>
                          </ValidationProvider>
                        ...
                        <div class="col-md-12">
                          <ValidationProvider name="CashAmount" mode="eager" rules="required" v-slot="{ errors }">
                            <div class="form-group row" style="padding-bottom: 10px">
                              <div class="col-lg-4 col-form-label text-center">
                                <div class="form-check">
                                  <input type="checkbox" class="form-check-input" id="cash" value="cash" v-model="form.cashSelected" @change="cashEnableDisable">
                                  <label class="form-check-label" for="cash">Cash</label>
                                </div>
                              </div>
                              <div class="col-lg-7">
                                <input name="CashAmount" type="text" id="CashAmount" class="form-control" v-model="form.CashAmount" :disabled="!form.cashSelected" @keyup="enterCashAmount" />
                                <div class="error" v-if="form.errors.has('CashAmount')" v-html="form.errors.get('CashAmount')" />
                                <span class="error-message"> {{ errors[0] }}</span>
                              </div>
                            </div>
                          </ValidationProvider>
                        ...
                        <div class="col-md-12">
                          <ValidationProvider name="TotalPayable" mode="eager" rules="required" v-slot="{ errors }">
                            <div class="form-group row" style="padding-bottom: 10px">
                              <div class="col-lg-4 col-form-label text-center">
                                <div class="form-check">
                                  <input type="checkbox" class="form-check-input" id="card" value="card" v-model="form.cardSelected" @change="cardEnableDisable">
                                  <label class="form-check-label" for="card">Card</label>
                                </div>
                              </div>
                              <div class="col-lg-7">
                                <input name="TotalCardAmount" type="text" class="form-control" v-model="form.TotalCardAmount" :disabled="true" />
                              </div>
                            </div>
                          </ValidationProvider>
                        </div>
                    ...
                    <div class="col-md-7">
                      <div class="row form-divider m-b-15">
                        ...
                        <div class="col-md-12" v-for="(tender, i) in tender_type" :key="tender.TenderId" v-if="tender_type.length">
                          <ValidationProvider name="SwipRate" mode="eager" rules="" v-slot="{ errors }">
                            <div class="form-group row" style="padding-bottom: 10px">
                              <div class="col-lg-3 col-form-label">
                                <div class="form-check">
                                  <input type="checkbox" class="form-check-input" name="TenderTypeSelect[]" :id="`Tend${i}`"
                                         :disabled="!form.cardSelected"
                                         :value="tender.TenderId"
                                         v-model="form.TenderTypeSelect" @change="TenderTypeSelect($event,`TenderTypeSelect${i}`, i, tender.TenderId)">
                                  <label class="form-check-label" :for="`Tend${i}`">{{ tender.TenderType }}</label>
                                </div>
                              </div>
                              <div class="col-lg-4">
                                <input name="CardAmount" type="text" class="form-control" @keyup="TenderAmountSelect(tender)"
                                       :id="`TenderTypeSelect${i}`" readonly="" v-model="tender.CardAmount" />
                                <div class="error" v-if="form.errors.has('CardAmount')" v-html="form.errors.get('CardAmount')" />
                                <span class="error-message"> {{ errors[0] }}</span>
                              </div>
                              <label class="col-lg-2 col-form-label">Swipe Rate</label>
                              <div class="col-lg-3">
                                <input type="number" name="SwipRate" class="form-control" :id="`SwipRate${i}`" :disabled="true" :value="tender.SwipeCharge" />
                                <div class="error" v-if="form.errors.has('SwipRate')" v-html="form.errors.get('SwipRate')" />
                                <span class="error-message"> {{ errors[0] }}</span>
                              </div>
                            </div>
                          </ValidationProvider>
                        ...
                        <tr>
                          <td>Total</td>
                          <td><input type="text" name="TotalAmount" id="TotalAmount" :value="form.TotalAmount" class="form-control" readonly=""></td>
                        </tr>
                        </table>
                      </div>
                    </div>
