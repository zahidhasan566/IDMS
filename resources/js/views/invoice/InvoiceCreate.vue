            ...
            <div class="card-body" id="customer_form">
              <ValidationObserver v-slot="{ handleSubmit }">
                <form @submit.prevent="handleSubmit(onSubmit)">
                  <div class="mb-2 radio-section">
                    <input type="radio" id="prebook" name="prebook" value="book" v-model="radioType"> <label for="prebook"> Booking</label>
                    <input type="radio" id="mr" name="prebook" value="receipt" v-model="radioType"> <label for="mr"> Money Receipt</label>
                  </div>
                  <div class="row">
                    <div class="col-md-4" v-if="radioType === 'book'">
                      ...
                      <button type="button" class="btn btn-info" @click="gerRecordsByBookingCode">Apply</button>
                    </div>
                    <div class="col-md-4" v-if="radioType === 'receipt'">
                      <div class="row form-divider m-b-15">
                        <div class="form-divider-title">
                          <p style="width: 160px">Money Receipt</p>
                        </div>
                        <div class="col-12 col-md-12">
                          <ValidationProvider name="Money Receipt Code" mode="eager" rules=""
                                              v-slot="{ errors }">
                            <div class="form-group">
                              <label>Money Receipt Code</label>
                              <input type="text" class="form-control"
                                     name="MoneyRecNo" v-model="form.MoneyRecNo">
                              <div class="error" v-if="form.errors.has('MoneyRecNo')"
                                   v-html="form.errors.get('MoneyRecNo')"/>
                              <span class="error-message"> {{ errors[0] }}</span>
                            </div>
                          </ValidationProvider>
                        </div>
                      </div>
                      <button type="button" class="btn btn-info" @click="gerRecordsByMoneyRecNo">Apply</button>
                    </div>
                  </div>
                  <br>
                          ...
                          <div class="col-md-5">
                            ...
                            <div class="form-group row" style="padding-bottom: 10px">
                              ...
                              <div class="col-lg-8">
                                ...
                                <div class="error" v-if="form.errors.has('PermanentAddress')"
                                     v-html="form.errors.get('PermanentAddress')"/>
                                <span class="error-message"> {{ errors[0] }}</span>
                              </div>
                            </div>
                  ...
                  <div class="row">
                    <div class="col-md-5">
                      <div class="row form-divider m-b-15">
                        ...
                        <div class="col-md-12">
                          <ValidationProvider name="TotalAmount" mode="eager"
                                              rules="" v-slot="{ errors }">
                            <div class="form-group row" style="padding-bottom: 10px">
                              <label class="col-lg-4 col-form-label text-center">Total Amount</label>
                              <div class="col-lg-7">
                                <input name="TotalAmount" type="text"
                        ...
                        <div class="col-md-12">
                          <ValidationProvider name="TotalPayable" mode="eager"
                                              rules="" v-slot="{ errors }">
                            <div class="form-group row" style="padding-bottom: 10px">
                              <label class="col-lg-4 col-form-label text-center">Payment ({{form.prePaymentType}})</label>
                              <div class="col-lg-7">
                                <input name="PreviousPayment" type="text"
                                       class="form-control" readonly
                                       v-model="form.preLoadedMoney"/>
                              </div>
                            </div>
                          </ValidationProvider>
                        </div>
                            ...
                            <div class="form-group row" style="padding-bottom: 10px">
                              ...
                              <div class="col-lg-7">
                                <input name="TotalPayable" type="text"
                                       class="form-control" readonly
                                       v-model="form.TotalPayable - form.preLoadedMoney"/>
                                <div class="error"
...
export default {
  ...
  methods: {
      ...
      if (this.form.BookingCode) {
        this.axiosGet('prebook/'+this.form.BookingCode,(response) => {
          if (response.data) {
            ...
            this.form.preLoadedMoney = response.data ? Number(response.data.BookingAmount) : 0
    ...
    gerRecordsByMoneyRecNo() {
      if (this.form.MoneyRecNo) {
        this.axiosGet('money-receipt/by-rec-no/'+this.form.MoneyRecNo,(response) => {
          if (response.invoice && response.invoice.Active === 'Y') {
            this.form.preLoadedMoney = 0
            this.form.preLoadedMoney = response.invoices.length > 0 ? response.invoices.reduce((sum,item) => sum + Number(item.Amount),0) : 0
            this.form.prePaymentType = 'Advance Money'
            this.form.prePaymentTypeId = 'AM'
    ...
    onSubmit() {
      ...
      let TotalPayable = Number(this.form.TotalPayable) - this.form.preLoadedMoney;
    ...
    validateEmergencyMobile(type) {
      ...
      if (type.length >= 11) {
        let number = ''
        if (type === 'EmergencyMobile') {
          number = this.form.EmergencyMobile
        } else {
