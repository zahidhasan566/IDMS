                        ...
                        <div class="card-body">
                            <ValidationObserver v-slot="{ handleSubmit }">
                                <form class="form-horizontal" style="padding-bottom: 30px" id="formProduction"
                                    ...
                                    <div class="content clearfix" style="margin-top: 5px">
                                        <h3 id="form-horizontal-h-3" tabindex="-1" class="title">Job Card Estimation list</h3>
                                        <fieldset id="form-horizontal-p-0" role="tabpanel"
                                                  aria-labelledby="form-horizontal-h-0" class="body current"
                                                  aria-hidden="false">
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <ValidationProvider name="job Card No" mode="eager" rules="required"
                                                                        v-slot="{ errors }">
                                                        <div class="form-group row">
                                                            <label for="jobCardNo" class="col-lg-3 col-form-label">Estimation Card No<span class="error">*</span></label>
                                                            <div class="col-lg-9">
                                                ...
                                                <div class="col-md-4">
                                                    <ValidationProvider name="Chassis No" mode="eager" rules="required"
                                                        ...
                                                        <div class="form-group row">
                                                            ...
                                                            <div class="col-lg-9">
                                                                <multiselect v-model="chassisNo" :options="allchassisNo"
                                                                             data-index="1"
                                                                             :multiple="false"
                                                ...
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="mobileNo" class="col-lg-3 col-form-label">Mobile
                                                            no</label>
                                                        <div class="col-lg-9">
                                                            <input type="tel" pattern='(0|88)?[0-9]{11}'
                                                                   class="form-control"
                                                                   data-index="2"
                                                                   id="mobileNo"
                                                                   data-required="true"
                                            ...
                                            <div class="row">
                                                <div class="col-md-4">
                                                    <div class="form-group row">
                                                        <label for="underWarrenty" class="col-lg-3 col-form-label">Under
                                                            Warrenty</label>
                                                        <div class="col-lg-9">
                        ...
                        <div class="modal-body">
                            <div class="table-responsive scrollable">
                                <table
                                    ...
                                    <tr>
                                        <th style="width: 50%;">Last Service Type</th>
                                        <td>{{ serviceHistoryLastServiceType }}</td>
                                    </tr>
                                    <tr>
                                        <th style="width: 50%;">Last Schedule Title</th>
                                        <td>{{ serviceHistoryLastScheduleTitle }}</td>
                                    </tr>
                                    <tr>
                                        <th style="width: 50%;">Last Service Date</th>
                                        <td>{{ serviceHistoryLastServiceDate }}</td>
                                    </tr>
                                    <tr>
                                        <th style="width: 50%;">Last Feedback Rating</th>
...
export default {
    ...
    mounted() {
        ...
        if (this.$route.query.action_type === 'edit') {
            let instance = this;
            let JobCardNo = this.$route.query.jobCardNo
            ...
            this.title = 'Add Job Card' +
                '';
            this.buttonText = "Record Estimation";
            this.transferNo = '';
        ...
        onSubmit() {
            ...
            if (this.duplicateErrors.length === 0 && this.errors.length === 0) {
                ...
                if (this.actionType === 'add') {
                    submitUrl = 'jobCard/job-estimation-add';
                }
