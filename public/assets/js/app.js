    ...
    !function (t) {
        ...
        e.prototype.intSlimscrollmenu = function () {
         ...
         //  t("#side-menu").metisMenu()
            ...
            this.intSlimscrollmenu(), this.initSlimscroll(), this.initLeftMenuCollapse(), this.initEnlarge(), this.initActiveMenu(), this.initComponents(), this.initFullScreen(), Waves.init()
